...
//Calling Api to set Data
  ...
  return (
    ...
    <View>
      <Text style={{fontSize:20,fontWeight:"bold", borderBottomWidth:3,borderColor:"purple"}}>Total World Cases: {getTotal}</Text>
      <Text style={{fontSize:20,fontWeight:"bold", borderBottomWidth:3,borderColor:"purple"}}>Total Recovered: {getRecovered}</Text>
      </View><View>
      <Text style={{fontSize:20,fontWeight:"bold", borderBottomWidth:3,borderColor:"violet"}}>Total Deaths: {getDeaths}</Text>
      <Text style={{fontSize:20,fontWeight:"bold", borderBottomWidth:3,borderColor:"violet"}}>Total Critical: {getCritical}</Text>
      </View><View>
      <Text style={{fontSize:15,fontWeight:"bold", borderBottomWidth:3,borderColor:"blue"}}>World Population: {getPopulation}</Text>
      <Text style={{fontSize:20,fontWeight:"bold", borderBottomWidth:3,borderColor:"blue"}}>Cases Ratio: {parseInt(getTotal/getPopulation*100)} %</Text>
      </View><View>
      <Text style={{fontSize:15,fontWeight:"bold", borderBottomWidth:3,borderColor:"grey"}}>Last Updated: {getUpdate}</Text>

    </View>
    <View style={{flexDirection: "row", justifyContent: "space-between", width: "100%"}}>
    <View style={{backgroundColor: '#7300ed', padding: 10, borderRadius: 10,}}>
